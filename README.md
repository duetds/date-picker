...
| `dates-to-disable`            | `dates-to-disable`               | In addition to min and max properties, you can specify dates to disable. Must be in IS0-8601 format: YYYY-MM-DD,YYYY-MM-DD,YYYY-MM-DD. This setting can be used alone or together with min and max properties.                                                                                                          | `string`                                                                                                                                                                                    | `""`                  |
