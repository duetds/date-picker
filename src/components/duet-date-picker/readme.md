...
| `multiple`       | `multiple`          | Use Multiple                                                                                                                                                                                                                                          | `boolean`                                                                                                                                                                                                                                                                                                                           | `false`               |
...
| `values`         | --                  | Date values. Must be in IS0-8601 format: YYYY-MM-DD.                                                                                                                                                                                                  | `string[]`                                                                                                                                                                                                                                                                                                                          | `[]`                  |
...
| `duetChanges` | Event emitted when a date is selected.          | `CustomEvent<{ component: "duet-date-picker"; values: string[]; }>`                 |
