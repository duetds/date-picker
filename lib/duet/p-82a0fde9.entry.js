    ...
    return (h("div", { class: "duet-date-input" },
        h("div", { class: {
            ...
            h("div", { class: "duet-input-relative" },
                h("input", { name: name, value: value, class: "duet-input", placeholder: placeholder, id: identifier, disabled: disabled, role: role, "aria-autocomplete": "none", onInput: onInput, onFocus: onFocus, onBlur: onBlur, autoComplete: "off", ref: inputRef }),
